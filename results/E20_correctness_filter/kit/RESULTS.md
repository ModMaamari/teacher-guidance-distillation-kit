...
| mixall17 | heldout_2wikimultihopqa | 170 | yes | 0.047 | 0.192 | 0.718 | 0.729 | 0.812 | 2.96 | 0.04 | 5,298 | 18.7 | 0.0000 |
| mixall17 | heldout_hotpotqa | 189 | yes | 0.265 | 0.354 | 0.635 | 0.651 | 0.778 | 2.78 | 0.22 | 4,984 | 17.8 | 0.0000 |
| mixall17 | heldout_musique | 203 | yes | 0.069 | 0.182 | 0.369 | 0.414 | 0.630 | 2.96 | 0.04 | 5,330 | 18.6 | 0.0000 |
| mixall17 | heldout_strategyqa | 185 | yes | 0.000 | 0.033 | 0.524 | 0.703 | 0.837 | 2.92 | 0.08 | 5,153 | 19.1 | 0.0000 |
| mixall23 | heldout_2wikimultihopqa | 170 | yes | 0.029 | 0.185 | 0.729 | 0.759 | 0.841 | 2.94 | 0.06 | 5,276 | 9.6 | 0.0000 |
| mixall23 | heldout_hotpotqa | 189 | yes | 0.286 | 0.380 | 0.651 | 0.667 | 0.780 | 2.74 | 0.26 | 4,860 | 9.0 | 0.0000 |
| mixall23 | heldout_musique | 203 | yes | 0.049 | 0.173 | 0.360 | 0.429 | 0.628 | 2.93 | 0.07 | 5,260 | 9.5 | 0.0000 |
| mixall23 | heldout_strategyqa | 185 | yes | 0.000 | 0.030 | 0.503 | 0.697 | 0.828 | 2.90 | 0.10 | 4,982 | 10.1 | 0.0000 |
...
| mixall17 | heldout_2wikimultihopqa, heldout_hotpotqa, heldout_musique, heldout_strategyqa | 747 | 0.096 | 0.191 | 0.554 | 0.617 | 2.90 | 5,191 | 0.0000 |
| mixall23 | heldout_2wikimultihopqa, heldout_hotpotqa, heldout_musique, heldout_strategyqa | 747 | 0.092 | 0.193 | 0.553 | 0.630 | 2.88 | 5,094 | 0.0000 |
...
| base -> mixall17 | heldout_2wikimultihopqa | +37.6 | [+29.4, +45.9] | 69 / 5 | 0 |
| base -> mixall17 | heldout_hotpotqa | +22.2 | [+14.8, +29.6] | 53 / 11 | 0 |
| base -> mixall17 | heldout_musique | +24.1 | [+16.8, +31.5] | 60 / 11 | 0 |
| base -> mixall17 | heldout_strategyqa | +55.1 | [+47.6, +62.7] | 104 / 2 | 0 |
| base -> mixall17 | pooled | +34.4 | [+30.5, +38.4] | 286 / 29 | 0 |
| base -> mixall23 | heldout_2wikimultihopqa | +40.6 | [+32.4, +48.8] | 75 / 6 | 0 |
| base -> mixall23 | heldout_hotpotqa | +23.8 | [+16.4, +31.2] | 53 / 8 | 0 |
| base -> mixall23 | heldout_musique | +25.6 | [+18.2, +33.5] | 65 / 13 | 0 |
| base -> mixall23 | heldout_strategyqa | +54.6 | [+47.6, +61.6] | 102 / 1 | 0 |
| base -> mixall23 | pooled | +35.7 | [+31.7, +39.8] | 295 / 28 | 0 |
...
| correct13 -> mixall17 | heldout_2wikimultihopqa | -5.9 | [-11.2, -0.6] | 6 / 16 | 0.0525 |
| correct13 -> mixall17 | heldout_hotpotqa | -3.7 | [-9.0, +1.6] | 9 / 16 | 0.23 |
| correct13 -> mixall17 | heldout_musique | -7.9 | [-13.8, -2.0] | 12 / 28 | 0.0166 |
| correct13 -> mixall17 | heldout_strategyqa | -2.2 | [-5.9, +1.6] | 4 / 8 | 0.388 |
| correct13 -> mixall17 | pooled | -5.0 | [-7.6, -2.4] | 31 / 68 | 0.000255 |
| correct13 -> mixall23 | heldout_2wikimultihopqa | -2.9 | [-8.2, +2.4] | 8 / 13 | 0.383 |
| correct13 -> mixall23 | heldout_hotpotqa | -2.1 | [-7.4, +3.2] | 11 / 15 | 0.557 |
| correct13 -> mixall23 | heldout_musique | -6.4 | [-11.8, -1.0] | 11 / 24 | 0.041 |
| correct13 -> mixall23 | heldout_strategyqa | -2.7 | [-7.0, +1.6] | 6 / 11 | 0.332 |
| correct13 -> mixall23 | pooled | -3.6 | [-6.3, -1.1] | 36 / 63 | 0.00863 |
...
| correct17 -> mixall13 | heldout_2wikimultihopqa | +0.0 | [-5.3, +5.3] | 10 / 10 | 1 |
| correct17 -> mixall13 | heldout_hotpotqa | -1.1 | [-5.3, +3.2] | 7 / 9 | 0.804 |
| correct17 -> mixall13 | heldout_musique | -3.0 | [-8.4, +2.5] | 13 / 19 | 0.377 |
| correct17 -> mixall13 | heldout_strategyqa | -3.2 | [-8.1, +1.6] | 8 / 14 | 0.286 |
| correct17 -> mixall13 | pooled | -1.9 | [-4.3, +0.7] | 38 / 52 | 0.17 |
| correct17 -> mixall17 | heldout_2wikimultihopqa | -4.7 | [-10.6, +0.6] | 8 / 16 | 0.152 |
| correct17 -> mixall17 | heldout_hotpotqa | -1.6 | [-5.3, +2.6] | 6 / 9 | 0.607 |
| correct17 -> mixall17 | heldout_musique | -3.9 | [-8.9, +1.0] | 10 / 18 | 0.185 |
| correct17 -> mixall17 | heldout_strategyqa | -2.7 | [-7.0, +1.6] | 6 / 11 | 0.332 |
| correct17 -> mixall17 | pooled | -3.2 | [-5.6, -0.8] | 30 / 54 | 0.0116 |
| correct17 -> mixall23 | heldout_2wikimultihopqa | -1.8 | [-7.1, +3.5] | 9 / 12 | 0.664 |
| correct17 -> mixall23 | heldout_hotpotqa | +0.0 | [-4.2, +4.2] | 8 / 8 | 1 |
| correct17 -> mixall23 | heldout_musique | -2.5 | [-7.9, +3.0] | 13 / 18 | 0.473 |
| correct17 -> mixall23 | heldout_strategyqa | -3.2 | [-8.6, +2.2] | 10 / 16 | 0.327 |
| correct17 -> mixall23 | pooled | -1.9 | [-4.4, +0.7] | 40 / 54 | 0.18 |
...
| correct23 -> mixall13 | heldout_2wikimultihopqa | +4.1 | [-1.2, +9.4] | 14 / 7 | 0.189 |
| correct23 -> mixall13 | heldout_hotpotqa | -1.1 | [-5.8, +3.7] | 9 / 11 | 0.824 |
| correct23 -> mixall13 | heldout_musique | -2.5 | [-8.4, +3.5] | 17 / 22 | 0.522 |
| correct23 -> mixall13 | heldout_strategyqa | -0.5 | [-5.4, +4.3] | 10 / 11 | 1 |
| correct23 -> mixall13 | pooled | -0.1 | [-2.8, +2.5] | 50 / 51 | 1 |
| correct23 -> mixall17 | heldout_2wikimultihopqa | -0.6 | [-5.9, +4.7] | 10 / 11 | 1 |
| correct23 -> mixall17 | heldout_hotpotqa | -1.6 | [-5.8, +2.6] | 7 / 10 | 0.629 |
| correct23 -> mixall17 | heldout_musique | -3.5 | [-9.8, +2.5] | 17 / 24 | 0.349 |
| correct23 -> mixall17 | heldout_strategyqa | +0.0 | [-4.3, +4.3] | 9 / 9 | 1 |
| correct23 -> mixall17 | pooled | -1.5 | [-4.0, +1.1] | 43 / 54 | 0.31 |
| correct23 -> mixall23 | heldout_2wikimultihopqa | +2.4 | [-2.9, +7.6] | 13 / 9 | 0.523 |
| correct23 -> mixall23 | heldout_hotpotqa | +0.0 | [-4.8, +4.8] | 10 / 10 | 1 |
| correct23 -> mixall23 | heldout_musique | -2.0 | [-7.4, +3.5] | 15 / 19 | 0.608 |
| correct23 -> mixall23 | heldout_strategyqa | -0.5 | [-4.9, +3.8] | 8 / 9 | 1 |
| correct23 -> mixall23 | pooled | -0.1 | [-2.7, +2.4] | 46 / 47 | 1 |
...
| mixall13 -> mixall17 | heldout_2wikimultihopqa | -4.7 | [-9.4, +0.0] | 5 / 13 | 0.0963 |
| mixall13 -> mixall17 | heldout_hotpotqa | -0.5 | [-4.8, +3.7] | 8 / 9 | 1 |
| mixall13 -> mixall17 | heldout_musique | -1.0 | [-6.9, +4.4] | 16 / 18 | 0.864 |
| mixall13 -> mixall17 | heldout_strategyqa | +0.5 | [-4.3, +5.4] | 10 / 9 | 1 |
| mixall13 -> mixall17 | pooled | -1.3 | [-3.8, +1.1] | 39 / 49 | 0.337 |
| mixall13 -> mixall23 | heldout_2wikimultihopqa | -1.8 | [-6.5, +2.9] | 6 / 9 | 0.607 |
| mixall13 -> mixall23 | heldout_hotpotqa | +1.1 | [-2.6, +4.8] | 8 / 6 | 0.791 |
| mixall13 -> mixall23 | heldout_musique | +0.5 | [-4.9, +5.9] | 17 / 16 | 1 |
| mixall13 -> mixall23 | heldout_strategyqa | +0.0 | [-4.3, +4.3] | 9 / 9 | 1 |
| mixall13 -> mixall23 | pooled | +0.0 | [-2.3, +2.3] | 40 / 40 | 1 |
...
| mixall13 -> mixmatch17 | heldout_2wikimultihopqa | -4.1 | [-8.8, +0.6] | 5 / 12 | 0.143 |
| mixall13 -> mixmatch17 | heldout_hotpotqa | +1.1 | [-3.7, +6.3] | 13 / 11 | 0.839 |
| mixall13 -> mixmatch17 | heldout_musique | +1.0 | [-4.4, +6.9] | 18 / 16 | 0.864 |
| mixall13 -> mixmatch17 | heldout_strategyqa | -1.1 | [-5.4, +3.2] | 8 / 10 | 0.815 |
| mixall13 -> mixmatch17 | pooled | -0.7 | [-3.1, +1.9] | 44 / 49 | 0.679 |
| mixall13 -> mixmatch23 | heldout_2wikimultihopqa | -1.8 | [-7.1, +3.5] | 9 / 12 | 0.664 |
| mixall13 -> mixmatch23 | heldout_hotpotqa | -2.6 | [-6.9, +1.6] | 6 / 11 | 0.332 |
| mixall13 -> mixmatch23 | heldout_musique | +1.5 | [-3.9, +7.4] | 19 / 16 | 0.736 |
| mixall13 -> mixmatch23 | heldout_strategyqa | +0.0 | [-4.3, +4.3] | 8 / 8 | 1 |
| mixall13 -> mixmatch23 | pooled | -0.7 | [-3.2, +1.7] | 42 / 47 | 0.672 |
...
| mixall17 -> mixall23 | heldout_2wikimultihopqa | +2.9 | [-2.4, +8.2] | 13 / 8 | 0.383 |
| mixall17 -> mixall23 | heldout_hotpotqa | +1.6 | [-2.6, +5.8] | 10 / 7 | 0.629 |
| mixall17 -> mixall23 | heldout_musique | +1.5 | [-3.9, +6.9] | 17 / 14 | 0.72 |
| mixall17 -> mixall23 | heldout_strategyqa | -0.5 | [-4.9, +4.3] | 9 / 10 | 1 |
| mixall17 -> mixall23 | pooled | +1.3 | [-1.1, +3.8] | 49 / 39 | 0.337 |
| mixall17 -> mixmatch13 | heldout_2wikimultihopqa | -1.2 | [-7.1, +4.1] | 11 / 13 | 0.839 |
| mixall17 -> mixmatch13 | heldout_hotpotqa | -0.5 | [-5.3, +3.7] | 9 / 10 | 1 |
| mixall17 -> mixmatch13 | heldout_musique | +0.5 | [-5.4, +6.4] | 19 / 18 | 1 |
| mixall17 -> mixmatch13 | heldout_strategyqa | -1.6 | [-6.5, +3.2] | 9 / 12 | 0.664 |
| mixall17 -> mixmatch13 | pooled | -0.7 | [-3.2, +1.9] | 48 / 53 | 0.691 |
| mixall17 -> mixmatch17 | heldout_2wikimultihopqa | +0.6 | [-4.7, +5.9] | 12 / 11 | 1 |
| mixall17 -> mixmatch17 | heldout_hotpotqa | +1.6 | [-3.2, +6.3] | 12 / 9 | 0.664 |
| mixall17 -> mixmatch17 | heldout_musique | +2.0 | [-3.9, +7.9] | 20 / 16 | 0.618 |
| mixall17 -> mixmatch17 | heldout_strategyqa | -1.6 | [-6.5, +3.2] | 9 / 12 | 0.664 |
| mixall17 -> mixmatch17 | pooled | +0.7 | [-1.9, +3.4] | 53 / 48 | 0.691 |
| mixall17 -> mixmatch23 | heldout_2wikimultihopqa | +2.9 | [-1.8, +7.6] | 12 / 7 | 0.359 |
| mixall17 -> mixmatch23 | heldout_hotpotqa | -2.1 | [-6.3, +1.6] | 5 / 9 | 0.424 |
| mixall17 -> mixmatch23 | heldout_musique | +2.5 | [-3.5, +8.4] | 21 / 16 | 0.511 |
| mixall17 -> mixmatch23 | heldout_strategyqa | -0.5 | [-5.4, +4.3] | 10 / 11 | 1 |
| mixall17 -> mixmatch23 | pooled | +0.7 | [-1.7, +3.2] | 48 / 43 | 0.675 |
| mixall17 -> wrongonly | heldout_2wikimultihopqa | -2.4 | [-8.2, +3.5] | 11 / 15 | 0.557 |
| mixall17 -> wrongonly | heldout_hotpotqa | -5.3 | [-9.5, -1.1] | 4 / 14 | 0.0309 |
| mixall17 -> wrongonly | heldout_musique | -1.5 | [-6.4, +3.5] | 12 / 15 | 0.701 |
| mixall17 -> wrongonly | heldout_strategyqa | -2.2 | [-7.6, +3.2] | 10 / 14 | 0.541 |
| mixall17 -> wrongonly | pooled | -2.8 | [-5.3, -0.3] | 37 / 58 | 0.0396 |
| mixall23 -> mixmatch13 | heldout_2wikimultihopqa | -4.1 | [-8.8, +0.6] | 5 / 12 | 0.143 |
| mixall23 -> mixmatch13 | heldout_hotpotqa | -2.1 | [-6.9, +2.6] | 9 / 13 | 0.523 |
| mixall23 -> mixmatch13 | heldout_musique | -1.0 | [-6.9, +4.4] | 16 / 18 | 0.864 |
| mixall23 -> mixmatch13 | heldout_strategyqa | -1.1 | [-5.9, +3.8] | 9 / 11 | 0.824 |
| mixall23 -> mixmatch13 | pooled | -2.0 | [-4.4, +0.5] | 39 / 54 | 0.146 |
| mixall23 -> mixmatch17 | heldout_2wikimultihopqa | -2.4 | [-7.6, +2.9] | 9 / 13 | 0.523 |
| mixall23 -> mixmatch17 | heldout_hotpotqa | +0.0 | [-4.8, +4.8] | 10 / 10 | 1 |
| mixall23 -> mixmatch17 | heldout_musique | +0.5 | [-4.9, +5.9] | 17 / 16 | 1 |
| mixall23 -> mixmatch17 | heldout_strategyqa | -1.1 | [-4.9, +2.7] | 6 / 8 | 0.791 |
| mixall23 -> mixmatch17 | pooled | -0.7 | [-3.1, +1.9] | 42 / 47 | 0.672 |
| mixall23 -> mixmatch23 | heldout_2wikimultihopqa | +0.0 | [-5.9, +5.9] | 13 / 13 | 1 |
| mixall23 -> mixmatch23 | heldout_hotpotqa | -3.7 | [-8.5, +0.5] | 6 / 13 | 0.167 |
| mixall23 -> mixmatch23 | heldout_musique | +1.0 | [-4.9, +6.9] | 19 / 17 | 0.868 |
| mixall23 -> mixmatch23 | heldout_strategyqa | +0.0 | [-4.9, +4.9] | 10 / 10 | 1 |
| mixall23 -> mixmatch23 | pooled | -0.7 | [-3.2, +2.0] | 48 / 53 | 0.691 |
| mixall23 -> wrongonly | heldout_2wikimultihopqa | -5.3 | [-10.6, -0.6] | 5 / 14 | 0.0636 |
| mixall23 -> wrongonly | heldout_hotpotqa | -6.9 | [-11.6, -2.1] | 5 / 18 | 0.0106 |
| mixall23 -> wrongonly | heldout_musique | -3.0 | [-7.9, +2.0] | 10 / 16 | 0.327 |
| mixall23 -> wrongonly | heldout_strategyqa | -1.6 | [-6.5, +2.7] | 8 / 11 | 0.648 |
| mixall23 -> wrongonly | pooled | -4.2 | [-6.6, -1.7] | 28 / 59 | 0.00117 |
